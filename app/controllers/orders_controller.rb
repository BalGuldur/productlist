class OrdersController < ApplicationController
  ...
  def create
    ...
    @order.statereserv=Statereserv.find_by(status: "Ожидает обработки")
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:manager_id, :numbill, :purchaser_id, :shipprice, :addrate, :datetimedone, :margin, :statereser_id, :comments)
    end
end
