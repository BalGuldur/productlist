class OrderpartsController < ApplicationController
  ...
  private
    ...
    def orderpart_params
      params.require(:orderpart).permit(:partnum, :descr, :qty, :psaleprice, :distrib, :doner_id, :state_id, :panswtime_id, :rezprice, :rezpricetype_id, :reztime_id, :nds, :beznal, :pshiptime_id, :shipprice, :convertion, :pmargin, :comment, :order_id)
    end
end
