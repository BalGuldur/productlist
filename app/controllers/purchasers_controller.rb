class PurchasersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @purchaser.save
        format.html { redirect_to :purchasers, notice: 'Purchaser was successfully created.' }
        format.json { render :index, status: :created, location: @purchaser }
      else
  ...
  def update
    respond_to do |format|
      if @purchaser.update(purchaser_params)
        format.html { redirect_to :purchasers, notice: 'Purchaser was successfully updated.' }
        format.json { render :index, status: :ok, location: @purchaser }
      else
  ...
  private
    ...
    def purchaser_params
      params.require(:purchaser).permit(:name, :phone, :employee_id)
    end
end
